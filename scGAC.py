...
data_path_vae = 'data/'+dataset_str+'/vae.csv'
...
print(data_path, data_path_vae, dataset_str, args.PCA_dim, args.is_NE, n_clusters, args.k)

# Read data
start_time = time.time()
A, cells, genes = load_data(data_path, dataset_str, 
                               args.PCA_dim, args.is_NE, n_clusters, args.k)

X = pd.read_csv(data_path_vae).values
end_time = time.time()
